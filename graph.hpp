...
namespace graph
{
    ...
    // Оператор присваивания копирования для  Node
    template<typename Key, typename Value, typename Weight>
    ...
    // Оператор присваивания перемещения для Node
    template<typename Key, typename Value, typename Weight>
    ...
    // Оператор доступа к элементам графа []
    template <typename key_type, typename value_type, typename weight_type>
